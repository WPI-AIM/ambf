...
psm_handle = _client.get_obj_handle('psm/pitchbacklink')
...
print(' ')
print('PSM Base pose:')
print(psm_handle.get_pose())

print(' ')
print('PSM Fixed Rotation:')
...
#quat = [0, 0, 0, 0]
#psm_handle.set_rot(quat)

#for i in range(0, 500):
#    psm_handle.set_rpy(roll, pitch, yaw)
##    psm_handle.set_rot(quat)
...
## python client code
#for i in range(0, 500):
#    psm_handle.set_force(0, 0, 30) # Set 10 N in the World Z axis
#    time.sleep(0.01) # Run the loop for 10 seconds
...
#for i in range(0, 500):
#    psm_handle.set_torque(-100, -100, -100) # Set 10 Nm in the World Y axis
#    time.sleep(0.01) # Run the loop for 10 seconds
